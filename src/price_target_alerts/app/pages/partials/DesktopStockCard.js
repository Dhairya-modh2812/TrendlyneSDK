...
export function DesktopStockCard({
    stock,
    setPriceAlert,
    deletePriceAlert,
    manageSwitchButton,
            ...
            <div className="desktop_only">
                <div className="card p-3 border_radius_10">
                    ...
                    <div className="row">
                        ...
                        <div
                            className={`col-xl-4 col-sm-12 mt-4 ${
                                stock && stock.below && stock.below.active
                                    ? ""
                                    : "disabled"
                            }`}
                            id={stock.id + "_desktop_1"}
                        >
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="form-check form-switch">
                                    <input
                                        ...
                                        type="checkbox"
                                        id={stock.id + "_desktop_id_1"}
                                        defaultChecked={stock.below?.active}
                                        onClick={(e) => {
                                            document
                                                .getElementById(
                                                    stock.id + "_desktop_ref_1"
                                                )
                                                .focus();
                                            manageSwitchButton(
                                                stock.id,
                                    ...
                                    <label
                                        ...
                                        htmlFor={stock.id + "_desktop_id_1"}
                                    >
                                        {" "}
                                    </label>
                                </div>
                            ...
                            <div className="input-group mt-2">
                                ...
                                <div
                                    ...
                                    id={stock.id + "_desktop_is_checked_1"}
                                >
                                    <span className="input-group-text bg-white">
                                        <span
                                            className="cursor-pointer"
                                            onClick={() => {
                                                let target_value = parseFloat(document.getElementById(stock.id + "_desktop_ref_1").value);
                                                if (target_value > stock?.current_price) {
                                                    handleToaster("You can not enter a value greater than last price.", "danger");
                                                    return false;
                                                }
                                                setPriceAlert({
                                                    stock_pk: stock.id,
                                                    ...
                                                    active: document.getElementById(stock.id + "_desktop_id_1").checked,
                                                });
                                            }}
                                        >
                                            <RightCheckbox />
                        ...
                        >
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="form-check form-switch">
                                    <input
                                        className="form-check-input"
                                        type="checkbox"
                                        id={stock.id + "_desktop_id_2"}
                                        defaultChecked={stock.above?.active}
                                        onClick={(e) => {
                                            document
                                                .getElementById(
                                                    stock.id + "_desktop_ref_2"
                                                )
                                                .focus();
                                            manageSwitchButton(
                                                stock.id,
                                    ...
                                    <label
                                        className="form-check-label"
                                        htmlFor={stock.id + "_desktop_id_2"}
                                    >
                                        {" "}
                                    </label>
                                </div>
                            ...
                            <div className="input-group mt-2">
                                ...
                                <div
                                    className="input-group-append border-start-0 d-none"
                                    id={stock.id + "_desktop_is_checked_2"}
                                >
                                    <span className="input-group-text bg-white">
                                        <span
                                            className="cursor-pointer"
                                            style={{ width: "25px" }}
                                            onClick={() => {
                                                let target_value = parseFloat(document.getElementById(stock.id + "_desktop_ref_2").value);
                                                if (target_value < stock?.current_price) {
                                                    handleToaster("You can not enter a value lesser than last price.", "danger");
                                                    return false;
                                                }
                                                setPriceAlert({
                                                    stock_pk: stock.id,
                                                    alertType: "above",
                                                    targetPrice: target_value,
                                                    active: document.getElementById(stock.id + "_desktop_id_2").checked,
                                                });
                                            }}
                                        >
                                            <RightCheckbox />
