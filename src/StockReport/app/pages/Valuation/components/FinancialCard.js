...
import { checkNumber, getPercentage, numberWithCommas, percentageRender } from '../../../utils/commonFunctions';
            ...
            <div className='financial-card mb-3'>
                <div className='financial-card-header'>
                    ...
                    <div className='d-flex align-items-center justify-content-between'>
                        <div>
                            {numbers && <span className='number f-20'>{data.unit == "%" ? `${numbers.toFixed(1)}%` : numberWithCommas(checkNumber(numbers))}</span>}
